...
namespace Solid.Infrastructure.Math
{
    ...
    public class Vector3D
    {
        ...
        /// <summary>API:YES 
        /// Returns true if this vector object is affine.
        /// </summary>
        /// <remarks>
        /// An affine vector is of the following format:
        /// <pre>
        /// | x y 1 |
        /// </pre>
        /// The value 1.0 is checked using the specified tolerance.
        /// A common tolerance value is Vector3D.DEFAULT_TOLERANCE.
        /// </remarks>
        /// <param name="v1">The given vector A.</param>
        /// <param name="tolerance">The specified tolerance.</param>
        /// <returns>True if the vector is affine otherwise false.</returns>
        private static bool IsAffine(Vector3D v1, double tolerance)
        {
            if (v1 == null)
            {
                throw new ArgumentNullException(nameof(v1));
            ...
            if (System.Math.Abs(v1.Z - 1.0) > tolerance)
            {
                return false;
            }
            return true;
        ...
        {
            return IsAffine(this, tolerance);
        }
        ...
        /// <apiflag>Yes</apiflag>
        /// <summary>API:YES 
        /// Calculates the nearest point onto a finite line.
        /// </summary>
        /// <remarks>
        /// This vector object is treated as the point of interest.
        /// The finite line is defined by the specified line start and line end point.
        ...
        /// <apiflag>Yes</apiflag>
        /// <summary>API:YES 
        /// Calculates the distance of a point of interest to a infinite line.
        /// </summary>
        /// <remarks>
        /// This vector object is treated as the point of interest.
        ...
        /// <apiflag>Yes</apiflag>
        /// <summary>API:YES 
        /// Calculates the nearest point onto a infinite line.
        /// </summary>
        /// <remarks>
        /// This vector object is treated as the point of interest.
